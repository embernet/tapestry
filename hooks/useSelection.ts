...
export const useSelection = ({
    ...
    activeView,
    colorSchemes, activeSchemeId, defaultTags, defaultRelationOverride,
    ...
    const handleNodeConnect = useCallback((sourceId: string, targetId: string) => {
        ...
        if (defaultRelationOverride) {
            // Use Quick Default Override
            defaultLabel = defaultRelationOverride;
        } else {
            // Use Schema Default
        ...
        setSelectedElementId(null);
        setPanelStateUI({ view: 'details', sourceElementId: null, targetElementId: null, isNewTarget: false });
    }, [activeSchemeId, colorSchemes, defaultRelationOverride, setRelationships, setSelectedRelationshipId, setSelectedElementId, setPanelStateUI]);
    ...
    const handleNodeConnectToNew = useCallback((sourceId: string, coords: { x: number; y: number }) => {
        ...
        setSelectedElementId(null);
        setSelectedRelationshipId(null);
    }, [defaultTags, defaultRelationOverride, activeSchemeId, colorSchemes, setElements, setRelationships, setPanelStateUI, setSelectedElementId, setSelectedRelationshipId]);
