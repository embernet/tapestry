...
export const usePanelState = () => {
  ...
  const [scriptPanelMode, setScriptPanelMode] = useState<'edit' | 'run'>('edit');
  ...
  return {
    ...
    isScriptPanelOpen, setIsScriptPanelOpen, activeScriptId, setActiveScriptId,
    scriptPanelMode, setScriptPanelMode,
