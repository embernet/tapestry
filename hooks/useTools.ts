...
export const useTools = (panelState?: any, settingsHandlers?: SettingsHandlers) => {
    // General Tool State
    ...
    const handleOpenTool = useCallback((tool: string, subTool?: string) => {
        ...
        if (toolId === 'triz') {
        ...
        } else if (toolId === 'mermaid' && panelState) {
            panelState.setIsMermaidPanelOpen(true);
        } else if (toolId === 'visualise' && panelState) {
        ...
        } else if (toolId === 'data' && panelState) {
        ...
        } else if (toolId === 'analysis' && panelState) {
        ...
        } else if (toolId === 'explorer' && panelState) {
        ...
        } else if (toolId === 'tagcloud' && panelState) {
            ...
            if (settingsHandlers) {
                settingsHandlers.onOpenSettings(subTool);
            }
        }
    }, [panelState, settingsHandlers]);
