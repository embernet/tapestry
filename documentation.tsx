...
export const TOOL_DOCUMENTATION: ToolDocumentationItem[] = [
            ...
            sections: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        "**ProgressBar:** `ProgressBar.Show()`, `ProgressBar.Update(percent, message)`, `ProgressBar.Hide()`.",
    ...
    {
        id: 'script-sys-report',
        name: "System Improvements Report",
        color: "text-green-500",
        desc: "AI-generated system analysis.",
        summary: "This script analyzes the real-world system described by your graph and calls the AI to generate a detailed Markdown report suggesting concrete improvements (efficiency, reliability, cost reduction). It focuses on the entity itself, not just the graph data structure.",
        icon: <path d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />,
        guidance: {
            title: "System Improvements Report",
            sections: [
                {
                    title: "How it works",
                    text: "The script iterates through all nodes and relationships, builds a text description of the system, and prompts the AI to act as a consultant. The resulting report is saved as a new document in your project."
                }
            ]
        }
    },
    {
        id: 'script-model-report',
        name: "Model Improvements Report",
        color: "text-blue-500",
        desc: "Graph structure analysis.",
        summary: "This script analyzes the completeness and connectivity of your knowledge graph. It prompts the AI to suggest structural improvements, such as missing connections, isolated nodes, or vague terminology, helping you build a more robust model.",
        icon: <path d="M19.428 15.428a2 2 0 00-1.022-.547l-2.384-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" />,
        guidance: {
            title: "Model Improvements Report",
            sections: [
                {
                    title: "How it works",
                    text: "Similar to the System Report, but the prompt is tuned to look for graph-theoretic weaknesses and semantic gaps rather than real-world system optimizations."
                }
            ]
        }
    },
    {
        id: 'ai-insight',
        name: "AI Concise Insight",
        color: "text-purple-500",
        desc: "Single-sentence deep insight.",
        summary: "Generates a 'Mic Drop' moment. The AI looks at the entire graph and delivers a single, profound sentence that captures the essence, irony, or hidden truth of the system you have modeled.",
        icon: <path d="M13 10V3L4 14h7v7l9-11h-7z" />,
        guidance: {
            title: "AI Concise Insight",
            sections: [
                {
                    title: "Usage",
                    text: "Use this when you want to distill complexity into a tagline or a core truth. It helps in communicating the 'big picture' to stakeholders."
                }
            ]
        }
    }
