...
export const BulkEditPanel: React.FC<BulkEditPanelProps> = ({
    ...
    const schemaTags = activeColorScheme ? Object.keys(activeColorScheme.tagColors).sort((a, b) => a.localeCompare(b)) : [];
            ...
            <div className="p-3 space-y-4">
                ...
                <div className="space-y-1">
                    ...
                    <div className={`flex flex-wrap gap-1.5 p-2 rounded-md border min-h-[42px] content-start ${inputContainerBg}`}>
                        {[...tagsToAdd].sort((a, b) => a.localeCompare(b)).map(tag => (
                            <span
                                key={tag}
                ...
                <div className="space-y-1">
                    ...
                    <div className={`flex flex-wrap gap-1.5 p-2 rounded-md border min-h-[42px] content-start ${inputContainerBg}`}>
                        {[...tagsToRemove].sort((a, b) => a.localeCompare(b)).map(tag => (
                            <span
                                key={tag}
