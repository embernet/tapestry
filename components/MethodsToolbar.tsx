    ...
    <div className="relative pointer-events-auto" onMouseLeave={handleMouseLeave}>
      ...
      {!isCollapsed && (
        <div className="relative">
            ...
            <div 
                ref={containerRef}
                className={`absolute top-2 left-0 w-64 border rounded-lg shadow-2xl z-40 flex flex-col overflow-hidden animate-fade-in-down ${dropdownBg}`}
            >
            ...
            {hoveredMethod && activeSubItems.length > 0 && (
                <div 
                    className={`absolute left-64 w-60 border rounded-lg shadow-2xl z-50 flex flex-col overflow-hidden animate-fade-in ${submenuBg}`}
