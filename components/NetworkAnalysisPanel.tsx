...
export const NetworkAnalysisPanel: React.FC<NetworkAnalysisPanelProps> = ({
    ...
    isHighlightToolActive, setIsHighlightToolActive, allocateZIndex, initialPosition
}) => {
    ...
    const { position, handleMouseDown: handleDragMouseDown } = usePanelDrag({
        initialPosition: initialPosition || { x: 20, y: 180 },
                        ...
                        {ANALYSIS_CATEGORIES.map(cat => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`text-xs px-2 py-2 rounded border transition-all flex justify-between items-center ${isActive
