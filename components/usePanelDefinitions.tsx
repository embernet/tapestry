...
import { Element, Relationship, TapestryDocument, TapestryFolder, HistoryEntry, StorySlide, MermaidDiagram, ModelActions, ColorScheme, PanelLayout, ChatMessage, GuidanceContent, GraphView, DateFilterState, NodeFilterState, KanbanBoard } from '../types';
...
interface UsePanelDefinitionsProps {
    ...
    // Actions
    onNodeClick: (elementId: string, e: MouseEvent) => void;
        ...
        const staticPanels: PanelDefinition[] = [
            ...
            },
            {
                ...
                content: <KanbanPanel
                    ...
                    isDarkMode={props.isDarkMode}
                    board={props.kanbanBoards.find(b => b.id === props.activeKanbanBoardId) || props.kanbanBoards[0]}
                    onUpdateBoard={(updatedBoard) => {
                        props.setKanbanBoards(prev => prev.map(b => b.id === updatedBoard.id ? updatedBoard : b));
                    }}
                    allBoards={props.kanbanBoards}
