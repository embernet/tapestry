...
export const QuickDefaultsPanel: React.FC<QuickDefaultsPanelProps> = ({
    ...
    const handleRelationChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        onDefaultRelationOverrideChange(val === '' ? null : val);
    };
            ...
            <div className="p-4 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <input
                        ...
                        placeholder={defaultSchemeLabel ? `Schema Default (${defaultSchemeLabel})` : 'Schema Default'}
                    ...
                    <datalist id="relation-options">
                        {activeSchemeRelationshipLabels.map(l => <option key={l} value={l} />)}
                    </datalist>
                </div>
