...
sleep(0.5)`}
                            ...
                            <div className="space-y-4">
                                <h4 className={`text-xl font-bold ${sectionTitle}`}>AI Automation (ai.*)</h4>
                                <div className={`border rounded-lg overflow-hidden ${groupBg}`}>
                                    <div className={`p-3 font-bold text-sm border-b ${groupHeaderBg} ${textHeader}`}>AI Operations</div>
                                    <table className={`w-full text-xs text-left ${textDesc}`}>
                                        <tbody className="divide-y divide-gray-700">
                                            <tr><td className="p-2 font-mono text-purple-400">ai.prompt(text="...")</td><td className="p-2">Sends text to the LLM and returns the response string.</td></tr>
                                            <tr><td className="p-2 font-mono text-purple-400">ai.propose(plan="...")</td><td className="p-2">Generates a multi-step plan for your approval.</td></tr>
                                            <tr><td className="p-2 font-mono text-purple-400">ai.insight()</td><td className="p-2">Generates a single-sentence profound insight about the graph.</td></tr>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
