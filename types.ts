...
export type NodeShape = 'rectangle' | 'oval' | 'containing_hexagon' | 'circle' | 'point' | 'diamond' | 'hexagon' | 'square';
...
export interface ChatMessage {
  ...
  suggestions?: { label: string; prompt: string }[]; // Suggested next steps
